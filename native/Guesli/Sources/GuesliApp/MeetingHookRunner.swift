...
private final class BoundedOutputBuffer {
    ...
    private let queue = DispatchQueue(label: "com.guesli.native.meeting-hook-output-buffer")
...
final class MeetingHookRunner: MeetingHookDispatching {
    private static let logger = Logger(subsystem: "com.guesli.native", category: "MeetingHook")
    private static let maxLoggedStandardErrorBytes = 4096

    private let supportDirectory: URL
    private let fileManager: FileManager
    private let logQueue = DispatchQueue(label: "com.guesli.native.meeting-hook-log")
    ...
    private func writeLog(_ message: String) {
        ...
        logQueue.sync {
            do {
                GuesliPaths.preconditionSafeForTestWrite(supportDirectory)
