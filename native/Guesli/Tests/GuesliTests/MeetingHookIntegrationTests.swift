...
@MainActor
@Suite("Meeting hook integration", .guesliHermeticSupport)
struct MeetingHookIntegrationTests {
    ...
    private func makeConfigStore() -> ConfigStore {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("guesli-hook-config-\(UUID().uuidString)", isDirectory: true)
        return ConfigStore(
    ...
    private func makeStore() throws -> DictationStore {
        let url = FileManager.default.temporaryDirectory
            .appendingPathComponent("guesli-hook-integration-\(UUID().uuidString).db")
    ...
    private func makeTemporaryDirectory() -> URL {
        let url = FileManager.default.temporaryDirectory
            .appendingPathComponent("guesli-hook-support-\(UUID().uuidString)", isDirectory: true)
