...
@Suite("PasteController — clipboard-preserving paste and keystroke simulation", .serialized, .guesliHermeticSupport)
struct PasteControllerTests {
    ...
    private func makePasteboard() -> NSPasteboard {
        let name = NSPasteboard.Name("com.guesli.tests.PasteController.\(UUID().uuidString)")
