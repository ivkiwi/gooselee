...
struct SidebarView: View {
    ...
    private var updateCTAForeground: Color {
        ...
        let defaultAccentHex = colorScheme == .dark
            ? GuesliTheme.defaultAccentDarkHex
            : GuesliTheme.defaultAccentLightHex
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: GuesliTheme.spacing4) {
            ...
            darkModeToggle
                .padding(.bottom, GuesliTheme.spacing16)
        }
        .frame(maxHeight: .infinity)
        .background(GuesliTheme.backgroundDeep)
    ...
    private var sidebarHeader: some View {
        VStack(alignment: .leading, spacing: GuesliTheme.spacing4) {
            HStack(spacing: GuesliTheme.spacing12) {
                Group {
                    if appState.config.menuBarIcon == "guesli",
        ...
        .padding(.bottom, GuesliTheme.spacing20)
    }
            ...
            HStack(spacing: GuesliTheme.spacing12) {
                Button {
                    ...
                    HStack(spacing: GuesliTheme.spacing12) {
                        ...
                        Text("Meetings")
                            ...
                            .foregroundStyle(isSelected ? GuesliTheme.textPrimary : GuesliTheme.textSecondary)
                        Spacer(minLength: 0)
                    }
                ...
                Button {
                    ...
                    Image(systemName: meetingsExpanded ? "chevron.down" : "chevron.right")
                        ...
                        .foregroundStyle(isSelected ? GuesliTheme.textSecondary : GuesliTheme.textTertiary)
    ...
    private var modelPreparationStatus: some View {
        if let title = appState.modelPreparationTitle {
            ...
            .background(
                RoundedRectangle(cornerRadius: GuesliTheme.cornerSmall)
                    .fill(GuesliTheme.backgroundRaised)
            )
            .overlay(
                RoundedRectangle(cornerRadius: GuesliTheme.cornerSmall)
                    .strokeBorder(GuesliTheme.surfaceBorder, lineWidth: 1)
        ...
        Button {
            ...
            HStack(spacing: GuesliTheme.spacing12) {
                ...
                if let updateCTA {
                    ...
                    .clipShape(Capsule())
                    .shadow(color: GuesliTheme.accent.opacity(0.35), radius: 8, x: 0, y: 2)
        ...
        HStack(spacing: 2) {
            Button {
                ...
                Image(systemName: "sun.max.fill")
                    ...
                    .foregroundStyle(!isDark ? GuesliTheme.accent : GuesliTheme.textTertiary)
                    .frame(width: 28, height: 22)
                    .background(
                        RoundedRectangle(cornerRadius: 4)
                            .fill(!isDark ? GuesliTheme.surfaceSelected : Color.clear)
                    )
            }
            .buttonStyle(.plain)
    ...
    private func meetingFilterRow(
        ...
        HStack(spacing: GuesliTheme.spacing8) {
            Image(systemName: icon)
                .font(.system(size: 11, weight: .medium))
                .foregroundStyle(isSelected ? GuesliTheme.accent : GuesliTheme.textTertiary)
                .frame(width: sidebarIconColumnWidth)
            Text(label)
                .font(GuesliTheme.callout())
                .foregroundStyle(isSelected ? GuesliTheme.textPrimary : GuesliTheme.textSecondary)
        ...
        .background(
            RoundedRectangle(cornerRadius: GuesliTheme.cornerSmall)
                .fill(isSelected ? GuesliTheme.surfaceSelected.opacity(0.6) : Color.clear)
        )
        .contentShape(Rectangle())
    ...
    private func folderRenameField(folder: MeetingFolder) -> some View {
        ...
        .background(
            RoundedRectangle(cornerRadius: GuesliTheme.cornerSmall)
                .fill(GuesliTheme.surfaceSelected.opacity(0.6))
        )
    }
