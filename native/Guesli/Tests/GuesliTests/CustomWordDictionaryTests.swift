...
struct CustomWordDictionaryTests {
    ...
    func decodesPortableArray() throws {
        let data = Data(
            #"[{"word":"museli","replacement":"guesli","matching_threshold":0.9}]"#.utf8
        )
    ...
    func exportsPortableEntries() throws {
        let words = [
            CustomWord(word: "museli", replacement: "guesli", matchingThreshold: 0.9),
        ]
    ...
    func mergesEntries() {
        ...
        let imported = [
            CustomWord(word: " guesli ", replacement: "Guesli", matchingThreshold: 0.9),
        ...
        #expect(result.words[0].word == "guesli")
