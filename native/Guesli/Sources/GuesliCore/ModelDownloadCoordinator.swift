...
/// Shared resumable downloader for Guesli-owned model artifacts.
public actor ModelDownloadCoordinator {
    ...
    private func stateURL(for directory: URL) -> URL { directory.appendingPathComponent(".guesli-download-state.json") }
