...
while IFS= read -r path; do
  [[ -n "$path" ]] || continue
  case "$path" in
    native/*|assets/*|LICENSE|scripts/*.sh|scripts/*.py|.github/workflows/ci.yml)
