...
struct DictionaryCorrectionDetector {
    ...
    private static let logger = Logger(subsystem: "com.guesli.native", category: "DictionaryCorrection")
...
final class DictationCorrectionMonitor {
    nonisolated private static let logger = Logger(subsystem: "com.guesli.native", category: "DictionaryCorrection")
