...
struct DictationsView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            if appState.config.resolvedOnboardingUseCase.includesVoiceNotes {
                ...
                .padding(.bottom, GuesliTheme.spacing12)
            }
            ...
            if appState.dictationRows.isEmpty {
                ...
                ScrollView {
                    LazyVStack(alignment: .leading, spacing: GuesliTheme.spacing20) {
                            ...
                            VStack(alignment: .leading, spacing: GuesliTheme.spacing8) {
                                HStack {
                                    Text(group.header)
                                        ...
                                        .foregroundStyle(GuesliTheme.textTertiary)
                                        .padding(.leading, GuesliTheme.spacing4)
                    ...
                    .padding(.horizontal, GuesliTheme.spacing24)
                    .padding(.bottom, GuesliTheme.spacing24)
                }
            }
        }
    }
    ...
    private var voiceNoteButton: some View {
        ...
        return Button {
            ...
            .frame(height: 30)
            .background(isRecording ? GuesliTheme.recording : GuesliTheme.accent)
