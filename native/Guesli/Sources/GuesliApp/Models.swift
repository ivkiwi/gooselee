...
struct PostProcessorOption: Identifiable, Equatable {
    ...
    var cacheDirectory: URL {
        FileManager.default.homeDirectoryForCurrentUser
            .appendingPathComponent(".cache/guesli/models/postproc-\(id)", isDirectory: true)
    }
    ...
    // Fine-tuned Qwen3-0.6B trained on Guesli dictation correction data.
    ...
    // Fine-tuned Qwen3.5-0.8B v3 trained on Guesli dictation correction data.
...
struct AppConfig: Codable {
    ...
    var customWords: [CustomWord] = [
        CustomWord(word: "guesli", replacement: "guesli"),
    ]
