...
final class MeetingSession {
    private static let logger = Logger(subsystem: "com.guesli.native", category: "MeetingSession")
    ...
    private let chunkRotationQueue = DispatchQueue(label: "Guesli.MeetingSession.chunkRotation")
    ...
    private func startSystemAudioWatchdog() {
        ...
        let timer = DispatchSource.makeTimerSource(queue: DispatchQueue(label: "Guesli.MeetingSession.systemAudioWatchdog"))
