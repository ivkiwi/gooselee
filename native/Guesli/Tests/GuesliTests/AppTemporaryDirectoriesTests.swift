...
@Suite("AppTemporaryDirectories", .guesliHermeticSupport)
struct AppTemporaryDirectoriesTests {
    ...
    func launchSweepDirectoryListCoversAppTempDirs() {
        ...
        let requiredNames: Set<String> = [
            "guesli-system-audio",
            "guesli-meeting-recordings",
            "guesli-native",
            "guesli-import",
            "guesli-wav-temp",
            "guesli-meeting-mic",
            "guesli-meeting-mic-audioqueue",
            "guesli-meeting-mic-app-scoped-fallback",
            "guesli-meeting-mic-chunks",
            "guesli-meeting-system-chunks",
            "guesli-meeting-mic-repair",
            "guesli-meeting-retranscription",
            "guesli-native-dictation",
            "guesli-native-dictation-streaming",
        ]
    ...
    func launchSweepRemovesOnlyOldAppTempEntries() throws {
        ...
        let root = fileManager.temporaryDirectory
            .appendingPathComponent("guesli-temp-sweep-tests-\(UUID().uuidString)", isDirectory: true)
        ...
        let unownedDirectory = root.appendingPathComponent("guesli-unowned", isDirectory: true)
...
@Suite("RecordingWaveformCacheFiles", .guesliHermeticSupport)
struct RecordingWaveformCacheFilesTests {
    ...
    func staleSweepRemovesOldWaveformFilesOnly() throws {
        let fileManager = FileManager.default
        let root = fileManager.temporaryDirectory
            .appendingPathComponent("guesli-waveform-cache-tests-\(UUID().uuidString)", isDirectory: true)
