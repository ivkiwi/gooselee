...
final class StreamingMicRecorder: StreamingDictationRecording, StreamingDictationLatencyReporting, PausableStreamingDictationRecording {
    ...
    private let failureCallbackQueue = DispatchQueue(label: "com.guesli.streaming-mic-recorder-failures")
    ...
    private let configurationChangeQueue = DispatchQueue(label: "com.guesli.streaming-mic-recorder-config-change")
