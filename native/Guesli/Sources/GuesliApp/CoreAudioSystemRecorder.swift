...
final class CoreAudioSystemRecorder: SystemAudioCapturing, SystemAudioDiagnosticsProviding {
    ...
    private let deviceIOQueue = DispatchQueue(label: "com.guesli.system-audio-tap.io", qos: .userInitiated)
    private let processingQueue = DispatchQueue(label: "com.guesli.system-audio-tap")
    ...
    private func createTapAndAggregateDevice() throws {
        ...
        // crashed session still holds the stable UID (or another Guesli
        ...
        var aggUID = "com.guesli.system-audio-tap"
        ...
        if status != noErr || aggregateDeviceID == kAudioObjectUnknown {
            ...
            aggUID = "com.guesli.system-audio-tap-fallback"
