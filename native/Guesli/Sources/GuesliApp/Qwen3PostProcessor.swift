...
enum Qwen3PostProcessorLogging {
    private static let verboseEnv = "GUESLI_DEBUG_POSTPROC_LOGS"
    private static let pairLogEnv = "GUESLI_LOG_POSTPROC_PAIRS"
...
enum Qwen3PostProcessorConfig {
    ...
    static let envOverride = "GUESLI_QWEN3_POSTPROC_GGUF"
    static let legacyDirectoryEnvOverride = "GUESLI_QWEN3_POSTPROC_DIR"
