...
@Suite("StreamingDictationController", .guesliHermeticSupport)
...
@Suite("Delta paste logic", .guesliHermeticSupport)
...
@Suite("Transcript accumulation", .guesliHermeticSupport)
...
@Suite("StreamingDictationController lifecycle", .guesliHermeticSupport)
...
@Suite("Nemotron dictation mode policy", .guesliHermeticSupport)
...
@Suite("Nemotron35 backend", .guesliHermeticSupport)
...
@Suite("Nemotron RNNT shape guards", .guesliHermeticSupport)
...
@Suite("Nemotron35 backend metadata", .guesliHermeticSupport)
...
@Suite("Nemotron35 language selection", .guesliHermeticSupport)
