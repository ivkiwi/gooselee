...
final class AudioQueueInputRecorder: StreamingDictationRecording, StreamingDictationLatencyReporting, PausableStreamingDictationRecording {
    ...
    private let processingQueue = DispatchQueue(label: "com.guesli.audio-queue-input-recorder-processing")
    private let failureCallbackQueue = DispatchQueue(label: "com.guesli.audio-queue-input-recorder-failures")
