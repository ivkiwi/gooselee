...
final class AppScopedDictationRecorder: DictationAudioRecording {
    ...
    init(
        ...
        prepareQueue: DispatchQueue = DispatchQueue(label: "com.guesli.app-scoped-dictation-recorder-prepare"),
        recorderQueue: DispatchQueue = DispatchQueue(label: "com.guesli.app-scoped-dictation-recorder-child"),
        callbackQueue: DispatchQueue = DispatchQueue(label: "com.guesli.app-scoped-dictation-recorder-callbacks")
    ) {
