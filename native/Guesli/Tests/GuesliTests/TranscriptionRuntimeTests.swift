...
@Suite("SpeechSegment", .guesliHermeticSupport)
...
@Suite("SpeechTranscriptionResult", .guesliHermeticSupport)
...
@Suite("Qwen3 inference gate", .guesliHermeticSupport)
...
@Suite("TranscriptionCoordinator routing", .guesliHermeticSupport)
...
@Suite("TranscriptionEngineArtifactsFilter", .guesliHermeticSupport)
...
@Suite("Qwen3 post-processing output cleanup", .guesliHermeticSupport)
...
@Suite("External transcript cleanup client", .guesliHermeticSupport)
