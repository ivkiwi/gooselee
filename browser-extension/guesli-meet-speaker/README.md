...
4. In Guesli, open **Settings → Meetings → Advanced**, enable the Google Meet speaker bridge, and copy its pairing token.
5. Open the extension's **Details → Extension options**, paste the token, and save it.
6. Join Google Meet and start a Guesli meeting recording.
...
Guesli accepts authenticated requests only while it is recording the matching active Google Meet.
